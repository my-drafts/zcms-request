...
const request2cookieString = require('./request2cookieString');
...
/**/
	...
	get cookieString(){ return this._cookieString; }
	...
	constructor(request){
		...
		this._cookieString = request2cookieString(request, '');
		Object.freeze(this._cookieString);
